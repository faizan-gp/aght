...
const steps = [
  {
    ...
    details: [
      { label: "Reserve Online", text: "Book at arcadegameshoustontexas.com. Weekends book out days in advance — secure your slot early." },
...
const breadcrumbSchema = {
  ...
  "itemListElement": [
    ...
    { "@type": "ListItem", "position": 2, "item": { "name": "What to Expect", "id": "https://arcadegameshoustontexas.com/what-to-expect" } },
  ],
};
...
const howToSchema = {
  ...
  "step": steps.map((s, i) => ({
    ...
    "name": s.title,
    "text": s.subtitle,
    "url": `https://arcadegameshoustontexas.com/what-to-expect#step-${s.num}`,
  })),
...
const articleSchema = {
  ...
  "author": { "@type": "Organization", "name": "Zero Latency Webster, Houston", "url": "https://arcadegameshoustontexas.com" },
  "publisher": { "@type": "Organization", "name": "Zero Latency Webster, Houston", "url": "https://arcadegameshoustontexas.com" },
};
