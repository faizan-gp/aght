...
export const metadata: Metadata = {
  title: 'Editorial Guidelines | Arcade Games Houston Texas',
  description: 'Editorial standards for content published on Arcade Games Houston Texas — accuracy, expertise, and transparency policies for our Houston arcade games and VR gaming guide.',
  alternates: { canonical: 'https://arcadegameshoustontexas.com/editorial-guidelines' },
...
const sections = [
  {
    ...
    content: (
      <p className="text-sm text-[#7DD3FC]/80 leading-relaxed">
        Content published on arcadegameshoustontexas.com is written and reviewed by the Zero Latency Webster, Houston team — staff with direct, hands-on experience running and playing free-roam VR sessions in Houston. Our writers have operated sessions, briefed hundreds of players, and tested every game title available in our arena.
      </p>
    ),
  },
  {
      ...
      <div className="mx-auto max-w-4xl px-4 sm:px-6">
        <div className="mb-12">
          ...
          <div className="glass rounded-2xl p-6">
            <p className="text-sm text-[#7DD3FC]/80 leading-relaxed">
              All content published on arcadegameshoustontexas.com meets the following editorial standards. Last reviewed: March 20, 2026.
            </p>
          </div>
        </div>
